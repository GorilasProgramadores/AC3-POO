...
import Pacote_Fonte_v1.Faculdade;
...
public class FaculdadeTest {
    ...
    public FaculdadeTest() throws FileNotFoundException {
        ...
        faculdade.carregarDadosArquivo(nomeArquivoDisciplinas, nomeArquivoEstudantes, nomeArquivoMatriculas);
    }
    ...
    public Estudante findEstudanteById(int id, ArrayList<Estudante> estudantes) {
    ...
    public Disciplina findDisciplinaByCodigo(String codigo, ArrayList<Disciplina> disciplinas) {
